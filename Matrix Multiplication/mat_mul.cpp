...
int main(int argc, char** argv)
{
    ...
    // Allocate host memory for result matrix C
    ...
    // Connect to ROG Flow x13 GPU
    int gpu = 1;
    err = clGetDeviceIDs(platform_ids[gpu], CL_DEVICE_TYPE_GPU, 1, &device_id, NULL);
    if (err != CL_SUCCESS)
    {
        ...
        printf("Successfully connected to GPU.\n");
    }
